...
import { useLocation, Link, useParams, Outlet, NavLink } from "react-router-dom";
		...
		<div className="w-full h-full">
			<div className="content-center dark:border-gray-700 mt-14">
				<section className="bg-white dark:bg-gray-900 h-screen content-center">
								...
								<li className="me-2">
									<NavLink
										...
										className={({ isActive, isPending }) =>
											`inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 group ${isPending ? "" : isActive ? "text-blue-600 dark:text-blue-500" : ""}`
										}
									>
										<svg
											className="w-4 h-4 me-2 "
					...
					<div className="h-full w-full flex justify-center bg-slate-50 pt-3">
						<Outlet />
					</div>
					{isModalVisible && (
						<UploadModal
