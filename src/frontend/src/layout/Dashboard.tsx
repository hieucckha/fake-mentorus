  ...
  <div className=" content-center dark:border-gray-700 mt-14">
    ...
    <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
        ...
        <div className="content-center justify-between">
            <img className="w-auto h-96  inline-flex justify-center items-center " src="https://www.gstatic.com/classroom/empty_states_home.svg" alt="empty states" />
        </div>
        <p className="mb-8 text-lg  font-medium  text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-400">Add a class to get started.</p>
        {/* <div style={{backgroundImage: 'url("https://www.gstatic.com/classroom/empty_states_home.svg")'}} /> */}
